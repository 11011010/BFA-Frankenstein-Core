...
bool BfCapturePoint::Update(uint32 diff)
{
    ...
    float fact_diff = ((float) m_activePlayers[TEAM_ALLIANCE].size() - (float) m_activePlayers[TEAM_HORDE].size()) * diff / AsUnderlyingType(BATTLEFIELD_OBJECTIVE_UPDATE_INTERVAL);
