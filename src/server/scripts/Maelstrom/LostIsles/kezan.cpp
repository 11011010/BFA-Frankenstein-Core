...
class quest_447 : public PlayerScript
{
public:
    quest_447() : PlayerScript(" quest_447") { }
...
class LifeSavings : public PlayerScript
{
public:
    LifeSavings() : PlayerScript("LifeSavings") { }
...
void AddSC_kezan()
{
    ...
    RegisterPlayerScript(LifeSavings);
    RegisterPlayerScript(quest_447);
}
