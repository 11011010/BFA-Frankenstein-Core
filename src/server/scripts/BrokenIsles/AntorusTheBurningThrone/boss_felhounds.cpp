...
struct boss_shatug_fhargAI : public BossAI
{
    ...
    void TwinDistanceAura()
    {
        ...
        {
            me->CastSpell(pOtherBoss, SPELL_SARGERAS_BLESSING, true);
            //crash now
            //me->CastSpell(pOtherBoss, 244051, true);
        ...
        else
        {
            ...
            //pOtherBoss->RemoveAurasDueToSpell(244051);
        }
    }
