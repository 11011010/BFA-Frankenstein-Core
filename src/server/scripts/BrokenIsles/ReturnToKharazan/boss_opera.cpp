    ...
    public:
        ...
        class spell_severe_dusting_AuraScript : public AuraScript
        {
            public:
                ...
                void Register() override
                {
                    OnEffectApply += AuraEffectApplyFn(spell_severe_dusting_AuraScript::HandleOnApply, EFFECT_0, SPELL_AURA_MOD_POSSESS_PET, AURA_EFFECT_HANDLE_REAL);
                    OnEffectPeriodic += AuraEffectPeriodicFn(spell_severe_dusting_AuraScript::HandlePeriodic, EFFECT_0, SPELL_AURA_MOD_POSSESS_PET);
                    OnEffectRemove += AuraEffectRemoveFn(spell_severe_dusting_AuraScript::HandleOnRemove, EFFECT_0, SPELL_AURA_MOD_POSSESS_PET, AURA_EFFECT_HANDLE_REAL);
                }
        };
