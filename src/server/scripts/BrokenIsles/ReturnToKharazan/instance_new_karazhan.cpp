...
struct instance_new_karazhan : public InstanceScript
{
    explicit instance_new_karazhan(InstanceMap* map) : InstanceScript(map)
    {
...
{
    RegisterInstanceScript(instance_new_karazhan, 1651);
}