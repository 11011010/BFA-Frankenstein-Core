                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_INTRO_SVALA_TALK_0:
                            ...
                            events.ScheduleEvent(EVENT_INTRO_ARTHAS_TALK_0, 8.1f * AsUnderlyingType(IN_MILLISECONDS), 0, INTRO);
                            break;
                        ...
                        case EVENT_INTRO_TRANSFORM_0:
                        {
                            ...
                            events.ScheduleEvent(EVENT_INTRO_TRANSFORM_1, 4.2f * AsUnderlyingType(IN_MILLISECONDS), 0, INTRO);
                            break;
                        }
                        case EVENT_INTRO_TRANSFORM_1:
                            me->CastSpell(me, SPELL_SVALA_TRANSFORMING1, false);
                            events.ScheduleEvent(EVENT_INTRO_TRANSFORM_2, 6.2f * AsUnderlyingType(IN_MILLISECONDS), 0, INTRO);
                            break;
                        ...
                        case EVENT_INTRO_SVALA_TALK_2:
                            ...
                            events.ScheduleEvent(EVENT_INTRO_RELOCATE_SVALA, 13.8f * AsUnderlyingType(IN_MILLISECONDS), 0, INTRO);
                            break;
